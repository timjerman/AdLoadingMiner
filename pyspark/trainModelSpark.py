...
def trainModel(fileName, saveModelName, outlierPercentile):
    ...
    model = RandomForest.trainRegressor(lp, categoricalFeaturesInfo={},
                                        numTrees=50, featureSubsetStrategy='auto',
                                        impurity='variance', maxDepth=25, maxBins=1024)

    model.save(sc, saveModelName)
...
if __name__ == '__main__':    
    ...
    saveModelName = 'E:/celtraMiningFrik/sparkRFmodel'
    outlierPercentile = 95.25    
    
    trainModel(fileName, saveModelName, outlierPercentile)